...
MYSQL_CHARACTER_SETS: List[Optional[Tuple[str, str, bool]]] = [
    ...
    ("utf16", "utf16_swefurniture_ci", False),  # 109
    ...
    ("ucs2", "ucs2_swefurniture_ci", False),  # 136
    ...
    ("utf32", "utf32_swefurniture_ci", False),  # 168
    ...
    ("utf8mb3", "utf8mb3_swefurniture_ci", False),  # 200
    ...
    ("utf8mb4", "utf8mb4_swefurniture_ci", False),  # 232
...
MYSQL_CHARACTER_SETS_57: List[Optional[Tuple[str, str, bool]]] = [
    ...
    ("utf8", "utf8_swefurniture_ci", False),  # 200
